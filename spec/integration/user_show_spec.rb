...
RSpec.describe 'User Page Index', type: :feature do
  before :each do
    ...
    @post1 = Post.create(author_id: @user.id, title: 'Hello1', text: 'This is my first post!', comments_counter: 0, likes_counter: 0)
    @post2 = Post.create(author_id: @user.id, title: 'Hello2', text: 'This is my second post!', comments_counter: 0, likes_counter: 0)
    @post3 = Post.create(author_id: @user.id, title: 'Hello3', text: 'This is my third post!', comments_counter: 0, likes_counter: 0)
